...
function expBasico() {
    ...
    if (contStatusFelicidade > 0 && contStatusFelicidade <= 100 && limiteFelicidade == 0) {
...
if (comodo == "Quarto") {
    ...
    let words = ['perna', 'olhos', 'pular', 'negro', 'mexer', 'termo', 'nobre', 'senso', 'algoz', 'afeto', 'plena', 'sutil', 'fazer', 'vigor', 'assim', 'audaz', 'sanar', 'fosse', 'carne', 'inato', 'ideia', 'poder', 'moral', 'desde', 'justo', 'muito', 'sobre', 'honra', 'torpe', 'anexo', 'etnia', 'sonho', 'tange', 'amigo', 'lapso', 'expor', 'haver', 'casal', 'dengo', 'tempo', 'seara', 'pesar', 'arbil', 'genro', 'posse', 'causa', 'coser', 'dizer', 'corja', 'prole', 'saber', 'dever', 'brado', 'tenaz', 'crivo', 'comum', 'digno', 'temor', 'sendo', 'ceder', 'culto', 'assar', 'atroz', 'pauta', 'gleba', 'ainda', 'mundo', 'fugar', 'censo', 'estar', 'valha', 'forte', 'cozer', 'vulgo', 'denso', 'xibiu', 'pudor', 'regra', 'dogma', 'louco', 'criar', 'banal', 'round', 'jeito', 'clava', 'impor', 'ordem', 'pedir', 'tenro', 'apraz', 'desse', 'feliz', 'usura', 'mesmo', 'homem', 'servo', 'coisa', 'prosa', 'viril', 'presa', 'ontem', 'cunho', 'forma', 'limbo', 'manso', 'falar', 'devir', 'meiga', 'posso', 'fluir', 'afago', 'vendo', 'guisa', 'todos', 'puder', 'visar', 'acaso', 'valor', 'certo', 'temer', 'pleno', 'cisma', 'lugar', 'afins', 'bruma', 'gerar', 'obter', 'falso', 'crise', 'matiz', 'abrir', 'praxe', 'garbo', 'senil', 'fluco', 'havia', 'enfim', 'legal', 'ritmo', 'burro', 'tomar', 'pulha', 'parvo', 'bravo', 'valia', 'reter', 'vital', 'favor', 'olhar', 'prumo', 'grato', 'levar', 'parco', 'vivaz', 'casta', 'sagaz', 'laico', 'reles', 'morte', 'possa', 'ameno', 'tecer', 'linda', 'brega', 'prime', 'falta'];
    ...
    function checkEnter(event) {
        ...
        if (event.which === 13) {
            ...
            let palavraValida1 = 0

            for (let i = 0; i < words.length; i++) {
                if (palavraEscrita1.trim().toString() == words[i].trim()) {
                    palavraValida1++
                }
            }
            if (letra1.trim() == "" || letra2.trim() == "" || letra3.trim() == "" || letra4.trim() == "" || letra5.trim() == "") {
                ...
                if (linhaNumero == 6) {
                    ...
                    let animacaoLinha6 = 0
                        ...
                        document.getElementById('palavraCerta1').style.display = "block"
                        document.getElementById('palavraSorteada1').innerText = palavraSorteada1
            ...
            if (palavraEscrita1 == palavraSorteada1) {
                ...
                const sommAplausos = new Audio("EfeitosSonoros/Som Aplausos.m4a");
                sommAplausos.play();
